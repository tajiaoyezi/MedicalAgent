# ONLYOFFICE Integration Specification

## Purpose

ONLYOFFICE Document / Spreadsheet / Presentation / PDF 四类编辑器接入：按文件类型从文档中心打开、编辑、保存；pdf 预览与 AI 处理入口；ofd 转 PDF 只读预览；png/jpg 图片预览与视觉解析状态展示。受文档 ACL 与租户隔离约束。
