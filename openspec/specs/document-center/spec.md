# Document Center Specification

## Purpose
文档中心：文件空间（我的/团队/应用/回收站）、文件操作、文档级权限分级（owner/manage/edit/comment/view/none 六级 ACL）、文档版本与 file_hash，以及触发重新解析与索引的 document_events 事件契约。
